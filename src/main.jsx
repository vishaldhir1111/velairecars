  ...
  return (
    <motion.article className="car-card" whileHover={{ y: -8 }}>
      ...
      <div className="car-body">
        ...
        <button className="outline action-button" onClick={()=>{
          selectCar(car);
          onOpen(car);
        }}>
          View Details
    ...
    <AnimatePresence>
      <motion.div className="overlay">
        <motion.div className="modal">
          ...
          <img src={car.images[0]} style={{width:"100%", borderRadius:"12px"}} />
          ...
          <div className="modal-actions">
            ...
            <a href={`https://wa.me/447845589543?text=Hi I want ${car.title}`} className="btn outline" target="_blank">
              WhatsApp
            </a>
          </div>
  ...
  return (
    <main>
      ...
      <section id="fleet" className="fleet">
        ...
        <div className="grid">
          {cars.map(car=>(
            <CarCard key={car.title} car={car} onOpen={setSelected}/>
          ))}
        </div>
      </section>
